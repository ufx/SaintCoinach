...
namespace SaintCoinach.Ex {
    public abstract class DataRowBase : IDataRow {
        ...
        public virtual object this[int columnIndex] {
            get {
                if (_ValueReferences.ContainsKey(columnIndex) && _ValueReferences[columnIndex].TryGetTarget(out object value))
                    return value;

                Column column = Sheet.Header.GetColumn(columnIndex);
        ...
        public IEnumerable<object> ColumnValues() {
            ...
            foreach (Column column in Sheet.Header.Columns)
